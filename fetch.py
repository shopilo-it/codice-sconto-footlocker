#!/usr/bin/env python3
"""
Recupero codici sconto Foot Locker da shopilo.it
Sursa: https://shopilo.it/negozi/footlocker.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/footlocker.it"
STORE_NAME = "Foot Locker"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Foot Locker da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-footlocker)"
    }
    try:
